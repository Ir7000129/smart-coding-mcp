---
trigger: always_on
description: Advanced Smart Coding MCP rules for BMAD workflow optimization
---

# Smart Coding MCP - Advanced Rules

> Extends the base `smart-mcp.md` rules with BMAD-specific optimizations.
...
- **GOAL:** Find the canonical design patterns, interfaces, and data structures (e.g., persistence schemas) defined in the `Verse/game design/` folder.
...
- **NOTE:** The optimized chunker now indexes individual methods separately.
