...
import { chunkVerseFile } from "./verse-chunker.js";
...
export function smartChunk(content, file, config) {
  ...
  // Use specialized Verse chunker for .verse files
  // Verse is indentation-based with multi-line signatures and effect specifiers
  // The generic regex approach produces fragmented chunks for Verse
  if (ext === '.verse') {
    return chunkVerseFile(content, file, config);
  }
